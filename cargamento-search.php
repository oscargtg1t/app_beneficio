			...
			<div class="full-box nav-lateral-content">
				<figure class="full-box nav-lateral-avatar">
					...
					<figcaption class="roboto-medium text-center">
					 <br><small class="roboto-condensed-light">AGRICULTOR</small>
					</figcaption>
				</figure>
		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a href="cargamento-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE CARGAMENTOS</a>
					</li>
					<li>
						<a class="active" href="cargamento-search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR CARGAMENTO</a>
					</li>
					<li>
			...
			<div class="container-fluid">
				...
				<?php
							...
							$url = 'http://localhost:8012/appwebservice/cargamento.php?id_cargamento='. urlencode($_GET['id_cargamento']);
