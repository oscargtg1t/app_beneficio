	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-search fa-fw"></i> &nbsp; PESAJE
				</h3>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="pesaje-search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR CARGAMENTO</a>
					</li>
				</ul>	
			</div>
			...
			<div class="container-fluid">
				...
				<?php
							...
							if ($pesaje !== null) {
								...
								echo '<p><b>NO. CARGAMENTO:</b> '.$pesaje->id_cargamento.'</p>';
								echo '<p><b>CANT. PARCIALIDADES:</b> '.$pesaje->cant_parcialidades.'</p>';
